...
namespace PiDemo
{
    public static class MqttHelper
    {
        ...
        public static async Task Connect_Client()
        {
            ...
            using (var mqttClient = mqttFactory.CreateMqttClient())
            {
                ...
                var mqttClientOptions = new MqttClientOptionsBuilder()
                    ...
                    .WithCredentials("emqx", "Guohao866")
                    .Build();

                // This will throw an exception if the server is not available.
                // The result from this message returns additional data which was s101.34.1.127ent 
        ...
        public static async Task Connect_Client_Using_MQTTv5()
        {
            ...
            await mqttClient.PublishStringAsync("mqttnet/samples/topic/1", "333");
        ...
        public static async Task Connect_Client_Using_WebSockets()
        {
            ...
            using (var mqttClient = mqttFactory.CreateMqttClient())
            {
                var mqttClientOptions = new MqttClientOptionsBuilder().WithWebSocketServer("101.34.1.127:8083/mqtt").WithCredentials("emqx", "Guohao866").Build();
        ...
        public static async Task Connect_Client_Using_WebSocket4Net()
        {
            ...
            using (var mqttClient = mqttFactory.CreateMqttClient())
            {
                var mqttClientOptions = new MqttClientOptionsBuilder().WithWebSocketServer("101.34.1.127:8000/mqtt").Build();
        ...
        public static async Task Ping_Server()
        {
            ...
            using (var mqttClient = mqttFactory.CreateMqttClient())
            {
                var mqttClientOptions = new MqttClientOptionsBuilder().WithTcpServer("101.34.1.127").Build();
